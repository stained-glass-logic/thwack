...
public class AimerRenderer implements Disposable {
	...
	public AimerRenderer(SpriteBatch batch, ShapeRenderer shapeRenderer) {
		this.batch = batch;
		//this.shapeRenderer = shapeRenderer;

		this.ratAtlas = new TextureAtlas(Gdx.files.internal("GreenRat-Packed/Rat.atlas"));
